...
if relevance:
    ...
    st.caption("No judge feedback yet. Use the chat app to generate conversations.")

st.subheader("User feedback")
thumbs_up, thumbs_down = get_user_feedback_stats()
fb_col1, fb_col2 = st.columns(2)
fb_col1.metric("Thumbs up", int(thumbs_up or 0))
fb_col2.metric("Thumbs down", int(thumbs_down or 0))
